...
| `recent --since 7d [--type Run]` | List activities in the last N days/weeks (`7d`, `4w`, `12h`). Filter by type optional. |
| `activity <id>` | Full detail for one activity: splits, laps, cadence, watts. |
